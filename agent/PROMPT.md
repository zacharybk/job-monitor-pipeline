...
- **Do NOT resurface companies Zach has already applied to and heard nothing from:** ClickUp, Plaid. Also skip any company already present in the `applications` table. Big late-stage names have not been converting for him; weight seed-to-growth private companies higher.
